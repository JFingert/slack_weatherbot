    ...
    return new Promise(function(resolve, reject){
        return request(url, function (error, response, body) {
            ...
            if (res.currently && res.minutely) {
                ...
                var weatherString = weatherObj.temp + 'F in ' + loc.city + '. ' + weatherObj.rightNow + ' ' + weatherObj.today; 
...
WeatherBot.prototype.postTheMessage = function(message) {
    this.postMessageToChannel('bot-test', message, {as_user: true});
};
